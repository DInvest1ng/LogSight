...
from training.bert_pytorch.dataset import WordVocab
from training.bert_pytorch.dataset import LogDataset
from training.bert_pytorch.dataset.sample import fixed_window
